...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(rek1.hashCode());
        System.out.println(rek2.hashCode());
        System.out.println(rek3.hashCode());
        ...
        // jos equals-metodia ei ole ylikirjoitettu, menee sama rekisterinumero
        // toistamiseen listalle
